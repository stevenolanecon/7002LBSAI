...
Thursdays, 1 hour — live, via the Teams link in your timetable.
...
::: {.instructions-box}
This first session is a one-off: rather than run it live, I'm releasing it as a video today, before teaching properly starts. From Week 1 onwards, online sessions are live every Thursday, joined via the Teams link in your timetable — workshop on Friday, online session the following Thursday, every week.
:::
...
Every **Monday, 10am–12pm** — on Teams, or in my office: **Room 210, Redmonds Building**.

Book a slot via [SeeMyTutor](https://seemytutor.ljmu.ac.uk).
:::
::: {.col}
**After the workshop**

I'll stay behind after each Friday workshop, **4–5pm**, if you want to chat through questions from that session.
:::
:::
...
::: {.two-col}
::: {.col}
![](gabor-front-cover.png){height="320"}
:::
::: {.col}
...
::: {.fragment}
::: {.callout-note}
I'm currently negotiating with the library about an ebook licence for this textbook — I'll keep you posted. That said, if you can, I'd recommend purchasing the textbook. I guarantee it's a resource you'll return to again and again.
:::
:::
